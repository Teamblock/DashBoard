  ...
  const content = (
    <div
      ...
      className={classNames(
        ...
        "bg-[rgba(0,0,0,0.7)] !text-white focus:outline-none flex items-center gap-4 justify-between w-full px-4 py-3 rounded-md border border-gray-600 hover:border-purple-600"
      )}
    >
