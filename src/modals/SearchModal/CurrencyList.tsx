  ...
  return (
    <div
      ...
      className={classNames(
        ...
        `flex items-center w-full hover:bg-field/80 rounded-md px-4 py-2 token-${currency?.symbol}`
      )}
      style={style}
      ...
      <div className="flex items-center justify-between flex-grow gap-2 rounded cursor-pointer">
        <div className="flex flex-row items-center flex-grow gap-3">
          ...
          <div className="flex flex-col">
            <Typography variant="xxs" className="text-white">
              {currency.name}{" "}
...
const CurrencyList: FC<CurrencyList> = ({
  currencies,
  otherListTokens,
  className,
}) => {
  ...
  return (
    <div
      ...
      className={
        currencies.length
          ? `flex flex-col flex-1 m-1 flex-grow min-h-[8rem] maxMd:min-h-[7rem] overflow-hidden h-full divide-y divide-dark-800`
          : `flex flex-col flex-1 m-1 flex-grow overflow-hidden h-full divide-y divide-dark-800`
      }
    >
      <AutoSizer>
        {/*@ts-ignore TYPE NEEDS FIXING*/}
