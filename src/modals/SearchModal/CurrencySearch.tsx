    ...
    <>
      ...
      {showSearch && (
        <input
          ...
          className="w-full h-11 bg-field border border-Gray focus:border-Gray rounded-md placeholder-secondary font-normal text-sm text-white p-4 appearance-none"
        />
      )}
      ...
      <div className="h-full overflow-hidden -mt-2.5">
