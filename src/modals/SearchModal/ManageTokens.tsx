    ...
    <>
      <input
        ...
        className={classNames(
          ...
          "w-full bg-field border border-Gray focus:border-Indigo rounded-[0.350rem] placeholder-secondary font-bold text-base p-4 appearance-none"
        )}
        value={searchQuery}
        autoComplete="off"
      ...
      <HeadlessUiModal.BorderedContent className="flex flex-col bg-field !border-Gray rounded-[0.350rem] !p-0">
        <div className="flex items-center justify-between p-3">
          ...
          <Button
            ...
            className="rounded-[0.350rem] h-[2rem] w-[7rem] font-normal"
          >
            {i18n._(t`Clear all`)}
          </Button>
        </div>
