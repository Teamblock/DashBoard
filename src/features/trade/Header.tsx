  ...
  return (
    <div className="flex items-center justify-between mb-4 pb-1.5 space-x-3 border-b border-gray-600">
      ...
      <div className="flex items-center">
        <div className="grid grid-flow-col gap-1 items-center mx-1">
          {chainId === ChainId.ETHEREUM && (
            <div className="items-center  w-full h-full pl-3 space-x-3 rounded cursor-pointer text-green text-opacity-80 hover:text-opacity-100 flex hover:bg-dark-800">
              <svg
                width="18"
                height="20"
                viewBox="0 0 18 20"
              ...
              <div className=" md:block text-baseline">
                <Gas />
              </div>
            </div>
          )}
          <div className="relative flex items-center w-full h-full rounded-full hover:bg-ternary/50">
