            ...
            <div className="flex items-center gap-4">
              <Image
                src={
                  currency === SUSHI[ChainId.ETHEREUM]
                    ? '/images/tokens/energyfi-square.png'
                    : currency === XSUSHI
                    ? '/images/tokens/xenergyfi-square.png'
                    : '/images/tokens/energyfi-square.png'
                }
                alt="ENERGYFI"
                width="62px"
              ...
              <div className="flex flex-col items-start">
                ...
                {(currency === SUSHI[ChainId.ETHEREUM] || currency === XSUSHI) && (
                  ...
                  >
                    {currencies[field] === SUSHI[ChainId.ETHEREUM] ? i18n._(t`Use xENERGYFI`) : i18n._(t`Use ENERGYFI`)}
                  </Typography>
                )}
              </div>
            </div>
