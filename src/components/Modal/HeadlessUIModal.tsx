...
} from "app/components/Modal/SubmittedModalContent";
  ...
  return (
    <>
      ...
      <HeadlessUiModalControlled
        transitionChildCss={transitionChildCss}
        dialogCss={dialogCss}
        isOpen={open}
...
const HeadlessUiModalControlled: FC<ControlledModalProps> = ({
  ...
  return (
    ...
    >
      <Dialog
        as="div"
        className={classNames("fixed z-50 inset-0", dialogCss)}
        onClose={onDismiss}
        unmount={unmount}
      >
          ...
          >
            <div
              className={classNames(
                ...
                "bg-ternary border border-Gray lg:!max-w-lg",
                isDesktop ? MAX_WIDTH_CLASS_MAPPING[maxWidth] : "",
                isDesktop
                  ? `w-full`
                  : "w-[92vw] max-h-[85vh] overflow-auto hide-scrollbar",
