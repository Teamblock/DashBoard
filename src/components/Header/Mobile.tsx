...
const Mobile: FC<MobileProps> = ({ popoverCss }) => {
  ...
  return (
    <>
      <header className="w-full flex items-center justify-between min-h-[64px] h-[64px] px-4 bg-[#fff]">
        <div className="flex flex-grow justify-between items-center">
          <div className="">
            <MenuIcon strokeWidth={1} width={28} className="hover:text-black text-black cursor-pointer" onClick={() => setOpen(true)} />
          </div>
            ...
            <div className="absolute inset-0 overflow-hidden">
              ...
              <div className="fixed inset-y-0 left-0 pr-10 flex top-12 max-w-xs md:max-w-lg">
                ...
                >
                  ...
                  <div className="!w-[30rem] max-w-md bg-[#fff] overflow-y-auto hide-scrollbar">
                      ...
                      <div className='flex flex-col justify-center gap-4 mx-3 mt-3'>
                        ...
                        <div className="flex items-center justify-start gap-2">
                          <div className='flex w-full items-center border border-primary h-10 rounded-[0.350rem] justify-center'>
                            ...
                            {
                              <Web3Status web3ConnectClass="bg-black hover:bg-black/90 hover:text-white/90 font-normal text-white rounded-[0.350rem] w-full !h-[2.5rem]" />
                            }
                          </div>
                        </div>
                      </div>
