      ...
      <div className="grid gap-2">
        <div className="flex items-center justify-between ">
          <div className="flex items-center ">
            <Typography
              variant="xs"
              className="text-high-emphesis font-sora text-sm font-semibold"
            >
          ...
          <Button
            size="lg"
            color={slippageIsDefault ? "green" : "gray"}
            onClick={() =>
          ...
          <div
            className={classNames(
              slippageError === SlippageError.INVALID_INPUT
                ...
                ? "border-blue"
                : "border-dark-800",
              "border border-Gray h-[44px] flex items-center px-2 rounded-md bg-field"
            )}
            tabIndex={-1}
          >
              ...
              <input
                ...
                className={classNames(
                  slippageError === SlippageError.INVALID_INPUT
                    ? "text-red"
                    : "",
                  "font-bold bg-transparent placeholder-low-emphesis border-dark-800 rounded-md px-3 py-2 focus:border-blue w-full  "
                )}
                ...
                autoComplete="off"
              />
              <div className="w-px h-8 bg-Gray rounded-xl" />
      ...
      {!trident && (
        <div className="grid gap-2">
          <div className="flex items-center">
            ...
            >
              {i18n._(t`Transaction deadline(in minutes)`)}
            </Typography>
          ...
          <div className="flex items-center gap-2">
            <input
              className={classNames(
                ...
                "font-bold bg-field placeholder-low-emphesis border border-Gray rounded-md px-3 py-2 focus:border-blue w-full"
              )}
