    ...
    >
      ...
      <div className="flex flex-col gap-1.5 justify-center">
        {title && (
          <Typography
            weight={700}
            className={classNames(text, "text-left inline leading-6")}
          >
            {title}
          </Typography>
        )}
        <Typography
          variant="sm"
          weight={500}
          className={classNames(text, "text-left")}
        >
          {message}
        </Typography>
      </div>
      {dismissable && (
        <button
          ...
          className="inline-flex opacity-80 hover:opacity-100 focused:opacity-100 rounded text-white hover:text-high-emphesis focus:text-high-emphesis focus:outline-none focus:ring focus:ring-offset focus:ring-offset-purple focus:ring-purple"
        >
