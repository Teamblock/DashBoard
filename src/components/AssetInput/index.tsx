...
const AssetInputPanel = ({
  ...
  if (currency) {
    content = (
      <div
        className={classNames(
          error ? "border-red border-opacity-40" : "border-[#828282]",
          size === "md" ? "py-4" : "py-2",
      ...
      >
        ...
        <div className="flex flex-col flex-grow">
          ...
          >
            ...
            />
            {isDesktop && (
              <span className="text-xl pointer-events-none text-white">
                {currency?.symbol}
              </span>
            )}
          </Typography>
          <Typography
            ...
            className={
              error
                ? "text-red"
                : usdcValue && value
                ? "text-green ml-3 py-1"
                : "text-white ml-3 py-1"
            }
          >
...
const AssetInputPanelBalance: FC<AssetInputPanelBalanceProps> = ({
  ...
  let icon = (
    <WalletIcon
      width={16}
      height={14}
      className={classNames(balance ? "text-white" : "text-low-emphesis")}
    />
  );
  if (!spendFromWallet) {
    icon = (
      <BentoboxIcon
        ...
        height={16}
        className={classNames(
          balance ? "text-white" : "text-low-emphesis",
          "truncate"
        )}
      />
    );
  ...
  return (
    <div
      className={classNames(
        error ? "bg-red/10" : "",
        "flex justify-between py-5 px-3"
      )}
    >
...
const AssetInputWalletSwitch: FC<AssetInputWalletSwitchProps> = ({
  ...
  return (
    <div
      className={classNames(
        error ? "lg:border-red/40" : "lg:border-Gray",
        "lg:p-4 flex gap-1.5 items-center lg:border-r lg:border-t lg:border-b lg:bg-ternary lg:rounded-r lg:justify-center lg:min-w-[120px]"
      )}
    >
      <div className="flex items-center gap-3 lg:flex-col">
        <div className="flex flex-col order-1 lg:order-2">
          ...
          <Typography
            variant="sm"
            weight={700}
            className="text-right text-white lg:text-center lg:flex lg:gap-1 lg:items-center lg:justify-center"
          >
