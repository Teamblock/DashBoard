...
export default function Add() {
  ...
  return (
    <>
      <div className="w-full !h-auto flex items-center intro_section">
        <Container
          id="add-liquidity-page"
          className="my-0 mx-auto py-10 pb-20 md:pb-20"
        >
          <Head>
          ...
          <div className="space-y-4 maxMd:mx-2">
            <SwapLayoutCard>
              {/* <BackIcon
                onClick={() => router.back()}
                className="cursor-pointer mb-3 w-[15px] h-[15px] md:w-[20px] md:h-[20px]"
              /> */}
              <ExchangeHeader
              ...
              {addIsUnsupported ? (
                ...
                <>
                  {isDesktop ? (
                    ...
                    <Web3Status web3ConnectClass="bg-black hover:bg-black/95 hover:text-white/90 font-normal text-white rounded-[0.350rem]  w-full !h-12" />
                  )}
                </>
              ) : (
                <div className="flex flex-col gap-3">
