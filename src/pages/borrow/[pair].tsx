    ...
    <PairLayout>
      <Head>
        ...
        <meta
          ...
          name="description"
          /* @ts-ignore TYPE NEEDS FIXING */
          content={`Borrow ${pair?.asset?.symbol} against ${pair?.collateral?.symbol} collateral on Kashi by Energyfi`}
        />
        <meta
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-3xl text-high-emphesis">
                    {i18n._(t`Borrow ${pair.asset.tokenInfo.symbol}`)}
                  </div>
                  <div className="flex items-center">
          ...
          <Tab.List className="flex p-1 rounded bg-dark-800">
            <Tab
              className={({ selected }) =>
                ...
                } flex items-center justify-center flex-1 px-3 py-4 text-lg rounded cursor-pointer select-none text-secondary hover:text-white focus:outline-none`
              }
            >
              {i18n._(t`Borrow`)}
            </Tab>
        ...
        <Card className="h-full p-4 bg-dark-900 xl:p-0">
          <div className="flex-col space-y-2">
            ...
            <div className="flex justify-between">
              {/*@ts-ignore TYPE NEEDS FIXING*/}
              <div className="text-lg text-secondary">
                {i18n._(t`${pair?.collateral.tokenInfo.symbol} Strategy`)}
              </div>
