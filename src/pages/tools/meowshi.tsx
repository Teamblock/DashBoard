...
export default function Meowshi() {
  ...
  return (
    <Container id="meowshi-page" className="py-4 md:py-8 lg:py-12" maxWidth="2xl">
      <Head>
        <title>Meowshi | Energyfi</title>
        <meta key="description" name="description" content="EnergyFiSwap Meowshi..." />
        <meta key="twitter:description" name="twitter:description" content="EnergyFiSwap Meowshi..." />
        <meta key="og:description" property="og:description" content="EnergyFiSwap Meowshi..." />
      </Head>
      ...
      <div className="z-0 relative mb-[-38px] md:mb-[-54px] ml-0 md:ml-4 flex justify-between gap-6 items-center">
        ...
        <div className="bg-[rgba(255,255,255,0.04)] p-4 py-2 rounded flex flex-row items-center gap-4 mb-[54px]">
          ...
          <Typography variant="xs" weight={700}>
            {i18n._(t`MEOW tokens wrap xEnergyFi into BentoBox for double yields and can be
